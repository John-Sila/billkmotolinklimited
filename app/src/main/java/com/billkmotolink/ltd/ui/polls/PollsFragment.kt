...
import com.billkmotolink.ltd.databinding.FragmentPollsBinding
import com.billkmotolink.ltd.ui.Option
import com.billkmotolink.ltd.ui.Poll
import com.billkmotolink.ltd.ui.PollsAdapter
...
class PollsFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.pollsSwipeRefreshLayout.setOnRefreshListener {
            viewLifecycleOwner.lifecycleScope.launch {
                fetchUserContext()
                binding.pollsSwipeRefreshLayout.isRefreshing = false
            }
        }
        binding.pollsSwipeRefreshLayout.setColorSchemeResources(
            R.color.color4,
            R.color.color3,
