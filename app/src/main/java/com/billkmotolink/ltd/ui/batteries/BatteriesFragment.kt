...
import com.billkmotolink.ltd.databinding.FragmentBatteriesBinding
import com.billkmotolink.ltd.ui.Battery
import com.billkmotolink.ltd.ui.BatteryAdapter
...
class BatteriesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.batteriesSwipeRefreshLayout.setOnRefreshListener {
            viewLifecycleOwner.lifecycleScope.launch {
                fetchBatteries()
                binding.batteriesSwipeRefreshLayout.isRefreshing = false
            }
        }
        binding.batteriesSwipeRefreshLayout.setColorSchemeResources(
            R.color.color4,
            R.color.color3,
    ...
    private fun setUpScrolling() {
        ...
        binding.batteryRecyclerView.isNestedScrollingEnabled = false
    }
